        ...
        <nav className="navbar navbar-inverse nav-padding">
          <div className="container-fluid fluid-padding">
            <div className="navbar-header set-height-navBar">
              <img
                src={require(".././images/ticker_logo.png")}
                width="70px"
                height="50px"
                alt=""
              />
            ...
            <ul className="nav navbar-nav">
              ...
              <li>
                <Link to="/marketplace" onClick={this.handleClick}>
                  Marketplace
                </Link>
              </li>
              ...
              this.props.currentUser !== undefined ? (
                <>
                  ...
                  <li>
                    <Link to="/account" onClick={this.handleClick}>
                      Buy / Sell
                    </Link>
                  </li>
                </>
            ...
            <ul className="nav navbar-nav navbar-right">
              ...
              this.props.currentUser === undefined ? (
                ...
                <>
                  <li className="user-funds">
                    Current Balance: ${" "}
                    {parseFloat(
                      this.props.currentUser.account.total_funds
                    ).toFixed(2)}
                  </li>
                  <li>
                    <Link to="/" onClick={e => this.props.handleLogout(e)}>
