      ...
      <div className="container ">
        ...
        <div className="col-md-6">
          <div className="row myborder">
            <h4 className="h4-text">Sign Up Now | 100% Free | Full Access</h4>
            <hr />
            <form onSubmit={e => this.handleSubmit(e, this.state)}>
              ...
              <div className="input-group margin-bottom-20">
                <span className="input-group-addon">
                  <i className="glyphicon glyphicon-home mycolor" />
                </span>
                <input
                  className="form-control"
              ...
              <div className="input-group margin-bottom-20">
                <span className="input-group-addon">
                  <i className="glyphicon glyphicon-envelope mycolor" />
                </span>
                <input
                  className="form-control"
                  placeholder="Email"
              ...
              <div className="input-group margin-bottom-20">
                <span className="input-group-addon">
                  <i className="glyphicon glyphicon-gift mycolor" />
                </span>
                <input
                  className="form-control"
                  placeholder="Date of birth ex. 04/05/1996"
                  name="dob"
                  type="text"
                  onChange={this.handleChange}
